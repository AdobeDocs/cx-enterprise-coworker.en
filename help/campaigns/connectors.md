...
1. On the [Campaign Coworker homepage](https://coworker-campaigns.experience.adobe.com/), click **Customize** and select **Connectors**.
...
1. Enter your Instance URL, Client ID, and Client secret.

   >[!NOTE]
   >
   >Explain how to get that info here.
